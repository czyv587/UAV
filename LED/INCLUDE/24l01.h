...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
//NRF24L01寄存器操作命令
#define W_ACK_PYLOD     0xA8  //读配置寄存器,低5位为寄存器地址
#define FEATURE     	0x1D  //读配置寄存器,低5位为寄存器地址
...
//SPI(NRF24L01)寄存器地址
#define CONFIG_24l01          0x00  //配置寄存器地址;bit0:1接收模式,0发射模式;bit1:电选择;bit2:CRC模式;bit3:CRC使能;
