...
extern unsigned char flow1_[26];
i2c_frame f;
...
/*   while(1)
   {
	   hw_i2cRead(0x42,0x18,2,flow1_);Delayms(10);
	   f.ground_distance=flow1_[0]+flow1_[1]*256;
   }*/
/*   MS5611_init();
   temp=dd;
   Get_Pressure_offset(50);*/
//   while(1);
/*
...
//	delay14ms();
    ...
    if(k2==8)
    {
    	hw_i2cRead(0x42,0x16,26,flow1_);Delayms(10);
    	f.ground_distance=flow1_[2]+flow1_[3]*256;
    	k2=0;
    }
...
//		{
			...
			pwm_num3=pwm_num2/116.36;//pwm_num2/12.412;
		//	PWM_CH3(pwm_num3);
