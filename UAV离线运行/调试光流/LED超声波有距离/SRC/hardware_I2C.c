...
char hw_Single_MS5611_Write(unsigned char SlaveAddress,unsigned char REG_data)		     //void
{
   if (I2caRegs.I2CSTR.bit.BB == 1)
   {
      return I2C_BUS_BUSY_ERROR;
   ...
   while(!I2C_xrdy());
   I2caRegs.I2CSAR = SlaveAddress;//SlaveAddress
   I2caRegs.I2CCNT = 1;//REG_Address+REG_data
   //I2caRegs.I2CDXR = 0x00; //Send high byte of RomAddress    HAddress&0xFF
   I2caRegs.I2CMDR.all = 0x6E20;
  //    while(!I2C_xrdy());
   I2caRegs.I2CDXR = REG_data; //Send low byte of RomAddress
//   while(!I2C_xrdy());
//   I2caRegs.I2CDXR = REG_data;
   return I2C_SUCCESS;
}
