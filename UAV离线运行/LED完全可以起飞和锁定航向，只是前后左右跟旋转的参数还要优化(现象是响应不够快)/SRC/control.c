...
void PID_INIT(void)	   
{
	...
	Roll_core_ki=((float)(23))/100;//0/100;//((float)(BUF_recv[1]))/100;
	Roll_core_kd=((float)(10));//0;//((float)(BUF_recv[2]));

	Pitch_core_kp=((float)(float)(20));//90;//((float)(BUF_recv[3]));
	Pitch_core_ki=((float)(23))/100;//30/100;//((float)(BUF_recv[4]))/100;
	Pitch_core_kd=((float)(10));//20;//((float)(BUF_recv[5]));

	Yaw_core_kp=((float)(20));//((float)(BUF_recv[6]));
	Yaw_core_ki=((float)(23))/100;//((float)(BUF_recv[7]))/100;
	Yaw_core_kd=((float)(10));//((float)(BUF_recv[8]));

	Roll_shell_kp=((float)(30))/100;//0/100000;//((float)(BUF_recv[9]))/100000;
	Roll_shell_ki=((float)(0))/100000;//0/1000000;//((float)(BUF_recv[10]))/1000000;


	Pitch_shell_kp=((float)(30))/100;//80/100000;//((float)(BUF_recv[12]))/100000;
	Pitch_shell_ki=((float)(0))/100000;//0;//((float)(BUF_recv[13]))/1000000;

	Yaw_shell_kp=((float)(30))/100;//((float)(BUF_recv[15]))/100;
	Yaw_shell_ki=((float)(0))/100000;//((float)(BUF_recv[16]))/100000;
